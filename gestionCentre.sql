...
--
-- Hôte : localhost:8889
-- Généré le : lun. 31 jan. 2022 à 16:10
...
--
CREATE DATABASE IF NOT EXISTS `gestionCentre` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `gestionCentre`;
...
(3, 'sd', 'zfefz', 'wtfilmsh', '$2y$11$Q8D6DPjADezpfvfKtZnqiuCKMRNVAMgIbqN2uXkajUK.lYIQFnECa', NULL, NULL, NULL, NULL, 'visiteur');
